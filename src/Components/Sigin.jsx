        ...
        <div className='p-4 flex flex-col  h-full gap-3 sm:h-[75%] sm:min-w-[380px] sm:rounded-lg sm:shadow-lg bg-gray-100'>
          ...
          <form>
            ...
            <div className="mb-3 flex flex-col border-2 pl-3  border-gray-400">
              <label className='absolute text-[16px] -translate-y-3.5 bg-gray-100 e max-w-fit text-fuchsia-500 px-1'>
                Email Address
              </label>
            ...
            <div className="mb-3 flex flex-col border-2 pl-3  border-gray-400">
              <label className='absolute text-[16px] -translate-y-3.5 bg-gray-100  max-w-fit text-fuchsia-500 px-1'>
                Password
                </label>
              <input
                className='h-10 outline-none'
