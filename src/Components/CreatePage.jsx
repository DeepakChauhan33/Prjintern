  ...
  return (
    ...
    <>
         ...
         <main className='h-dvh sm:flex sm:justify-center sm:items-center sm:h-screen sm:w-screen'>
            ...
            <div 
            className='p-4 flex flex-col  h-full gap-3 sm:h-[75%] sm:min-w-[380px] sm:rounded-lg sm:shadow-lg bg-gray-100'>

              <h1 
              className='text-[25px] font-semibold mb-1.5'>
                Create your <br/>
                PopX account
              </h1>
             ...
             <form onSubmit={handleSubmit}  >
                ...
                <div className="mb-4.5 flex flex-col border-2 pl-3  border-gray-400 rounded-md  ">
                    <label 
                        className='absolute text-[16px] -translate-y-3.5 bg-gray-100 max-w-fit text-fuchsia-800 px-1 '>
                        Full Name 
